...
public class ImageViewExample extends ImageView {
...
/*		imageViewPaint.setColor(Color.WHITE); 
    ...
    public boolean onTouchEvent(MotionEvent event) {
        setImageDrawable(getResources().getDrawable(R.drawable.aaa5));
        refreshDrawableState();
     //   setBackground(getResources().getDrawable(R.drawable.aaa5));
